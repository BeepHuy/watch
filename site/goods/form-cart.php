...
if (isset($_SESSION['user'])) { //nếu tồn tại user thì cho đặt hàng
    if (isset($_GET['order'])) {
        ...
        <div class="grid wide">
            ...
            <div class="row no-gutters">
                <div class="col l-12 m-12 c-12">
                    ...
                    <p class="user-have-account">Bạn đã có tài khoản? <a href="<?= $SITE_URL ?>/account/login.php">Ấn
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="cart-item">
                                            <td class="product-name-your-bill"> <?= $product['ten_sp'] ?>
                                                ...
                                                <input type="text" hidden name="quantity[<?= $product['ma_sp']; ?>]"
                                                    value="<?= $so_luong; ?>">
                                            </td>
