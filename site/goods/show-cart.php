            ...
            <div class="row no-gutters">
                            ...
                            <table class="tb-form-show-cart">
                                ...
                                <tbody>
                                    ...
                                    <tr class="tr-product">
                                        ...
                                        <td class="img-product"><img
                                                src="<?= $CONTENT_URL ?>/images/img-admin/img-products/<?= $product['hinh'] ?>"
                                                alt=""></td>
                                        <td class="name-product"><a
                                                href="<?= $SITE_URL ?>/goods/detail.php?ma_sp=<?= $product['ma_sp'] ?>"><?= $product['ten_sp'] ?></a>
                                            <p class="l-0 m-0">
                                                <span class="amount-product-mobile"><?= $so_luong; ?> x</span>
                                                <span
                                                    class="price-product-mobile"><?= number_format($don_gia, 0, '.', ',') ?>
                                                    <span style="text-decoration: underline;">đ</span></span>
                                            </p>
                                        </td>
                                        <td class="price-product c-0"> <?= number_format($don_gia, 0, '.', ','); ?>
                                            <span style="text-decoration: underline;">đ</span>
                                        </td>
                                        <td class="amount-product">
                                            <div class="quantity">
                                                <!-- <input type="button" value="-" class="btn-minus-quantity is-form"> -->
                                                <input type="number" name="quantity[<?= $product['ma_sp'] ?>]"
                                                    class="ip-quantity" id="quantity" step="1" min="0" max="50"
                                                    value="<?= $so_luong; ?>">
                                                <!-- <input type="button" value="+" class="btn-plus-quantity is-form"> -->
                                            </div>
                                        </td>
                                        <td class="total-product c-0">
                                            <?= number_format($don_gia * $so_luong, 0, '.', ',') ?> <span
                                    ...
                                    <tr>
                                        <td class="td-continue-shopping" colspan="6">
                                            <div class="continue-shopping">
                                                <a href="<?= $SITE_URL ?>/goods/listed.php?continue_shopping"
                                                    class="button-continue-shopping">← TIẾP TỤC XEM SẢN PHẨM</a>
                                                <input type="submit" name="update_click" value="CẬP NHẬT GIỎ HÀNG"
                                                    class="update-shopping">
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                ...
                <div class="col l-5 m-12 c-12">
                    <div class="amount-show-cart">
                        ...
                        <div class="checkout">
                            <a href="<?= $SITE_URL ?>/goods/cart.php?btn_form_cart" class="button-checkout">TIẾN HÀNH
                                THANH TOÁN</a>
                        </div>
                        <form class="" method="POST" target="_blank" enctype="application/x-www-form-urlencoded"
                            action="../goods/xulymomoqrcode.php">
                            <input type="submit" value="Thanh toán MOMO QRcode" name="momo">
                        </form>
                        <form class="" method="POST" target="_blank" enctype="application/x-www-form-urlencoded"
                            action="../goods/xulymomoatm.php">
                ...
                <div class="col l-12 m-12 c-12">
                    <div class="cart-empty">
                        ...
                        <p><a href="<?= $SITE_URL ?>/goods/listed.php?continue_shopping" class="back-shop">Quay trở lại
                                cửa hàng</a></p>
                    </div>
                </div>
                <?php } ?>
