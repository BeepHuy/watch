                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="td-img"><img src="../../content/images/img-admin/img-products/nikeMen01.jpg " alt=""></td>
                                        <td class="hide">msp01</td>
                                        <td>Nike Love Yeolloe</td>
                                        ...
                                        <td class="td-child" colspan="4">
                                            <ul>
                                                <li>
                                                    ...
                                                    <span class="span-data">msp01</span>
                                                </li>
                                                <li>
                                    ...
                                    <tr>
                                        <td><label for="checkbox_see_more" class="td-see-more"><i class="fa-solid fa-plus see-more show"></i> <i class="fa-solid fa-minus no-see-more"></i><span>3</span></label></td>
                                        <td class="td-img"><img src="../../content/images/img-admin/img-products/nikeMen01.jpg " alt=""></td>
                                        <td class="hide">msp01</td>
                                        <td>Nike Love Yeolloe</td>
                                        <td class="hide">3.000.000 đ</td>
                                    ...
                                    <tr>
                                        <td><label for="checkbox_see_more" class="td-see-more"><i class="fa-solid fa-plus see-more show"></i> <i class="fa-solid fa-minus no-see-more"></i><span>4</span></label></td>
                                        <td class="td-img"><img src="../../content/images/img-admin/img-products/nikeMen01.jpg " alt=""></td>
                                        <td class="hide">msp01</td>
                                        <td>Nike Love Yeolloe</td>
                                        <td class="hide">3.000.000 đ</td>
                                    ...
                                    <tr>
                                        <td><label for="checkbox_see_more" class="td-see-more"><i class="fa-solid fa-plus see-more show"></i> <i class="fa-solid fa-minus no-see-more"></i><span>5</span></label></td>
                                        <td class="td-img"><img src="../../content/images/img-admin/img-products/nikeMen01.jpg " alt=""></td>
                                        <td class="hide">msp01</td>
                                        <td>Nike Love Yeolloe</td>
                                        <td class="hide">3.000.000 đ</td>
                                    ...
                                    <tr>
                                        <td><label for="checkbox_see_more" class="td-see-more"><i class="fa-solid fa-plus see-more show"></i> <i class="fa-solid fa-minus no-see-more"></i><span>6</span></label></td>
                                        <td class="td-img"><img src="../../content/images/img-admin/img-products/nikeMen01.jpg " alt=""></td>
                                        <td class="hide">msp01</td>
                                        <td>Nike Love Yeolloe</td>
                                        <td class="hide">3.000.000 đ</td>
