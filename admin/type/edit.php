                        ...
                        <div class="content-panel">
                            <form id="form" action="./list.php" method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <input class="readonly form-control" type="text" name="ma_loai" id="id_type" readonly value="ML01">
                                </div>
                                <div class="form-group">
                                    <label class="control-label" for="name_type">Tên loại <strong>*</strong></label>
                                    <input type="text" class="form-control" name="ten_loai" id="name_type" placeholder=" " value="Giày Nam"> <br>
                                </div>
