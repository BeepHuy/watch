        ...
        <div class="col">
            <div class="panel">
                <div class="title-panel">
                    <h2>Danh sách hãng giày <?php foreach ($amounts as $amount) extract($amount); ?>(<?= $so_luong ?>)
                    </h2>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $ma_hang ?></td>
                                <td>
                                    <a title="Sửa" href="index.php?btn_edit&ma_hang=<?= $ma_hang; ?>"><i
                                            class="fa-solid fa-pen-to-square"></i></a>
                                    <a title="Xoá" id="delete" data-tenhang="<?= $ten_hang ?>"
                                        href="index.php?btn_delete&ma_hang=<?= $ma_hang ?>"><i
    ...
    <div class="confirmModal">
        <div id="confirmationModal" class="modal">
            <div class="modal-content">
                <p id="modalText"></p><button id="confirmDelete">Xác nhận</button>
