                    ...
                                        <div class="img-detail">
                        ...
                                              <div class="slideshow-container">
                                                      <div class="mySlides fade">
                                                              <img
                                    src="<?= $CONTENT_URL ?>/images/img-admin/img-products/<?= $hinh ?>" alt=""
                    ...
                                      <div class="info-detail">
                        ...
                                              <div class="price-detail">
                                                      <del>
                                                              <?php
                                                                if ($giam_gia > 0) { ?>
                                                                  <del><?= number_format($don_gia, 0, ',', '.');
                                                                            ?>
                                    đ</del>
                                                              <?php } ?>
                                                          </del>
                                                      <p>
                                <?= number_format($don_gia - ($don_gia * ($giam_gia / 100)), 0, ',', '.'); ?> đ</p>
                                                  </div>
                                              <form action="cart.php?action=add" method="POST"
                            ...
                                                      <div class="quantity">
                                ...
                                                              <input type="number" name="quantity[<?= $ma_sp ?>]"
                                    class="ip-quantity" id="quantity" step="1" min="1" max="9999" value="1">
                                                              <input type="button" value="+"
                        ...
                                              <div class="box-detail">
                                                      <div class="icon-box-detail"><img
                                    src="<?= $CONTENT_URL ?>/images/img-site/icon-freeship-detail.jpg" alt=""></div>
                                                      <p class="text-box-detail">Miễn phí vận chuyển với tất cả các
                                mặt hàng</p>
                                                  </div>
                                              <div class="box-detail">
                                                      <div class="icon-box-detail"><img
                                    src="<?= $CONTENT_URL ?>/images/img-site/icon-insurance-detail.jpg" alt=""></div>
                                                      <p class="text-box-detail">Bảo hành 12 tháng do lỗi nhà sản
                                xuất</p>
                                                  </div>
                                              <div class="box-detail">
                                                      <div class="icon-box-detail"><img
                                    src="<?= $CONTENT_URL ?>/images/img-site/icon-new-detail.jpg" alt=""></div>
