            ...
            <div class="panel">
                <div class="title-panel">
                    ...
                    <form id="form" action="index.php" method="POST" enctype="multipart/form-data">
                        ...
                        <button type="submit" name="add" id="submit" class="btn_success">Lưu lại</button>
...
<script>
    const checkAdd = document.querySelectorAll("#submit");
    checkAdd.forEach(function(checkAdd){
        checkAdd.addEventListener('click', function(event){
            const mess = alert("Bạn có chắc chắn muốn thêm sản phẩm này không?");
            if(mess == false){
