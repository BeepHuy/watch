...
<body>
    <div class="grid wide">
        <div class="wrapper-login">
            <form id="form-update" action="update-account.php" method="post" class="main-login"
                enctype="multipart/form-data">
                <h2 class="title-login">Cập nhật tài khoản</h2>
                <div class="form-group">
                    <label class="label-control" for="username">Tên đăng nhập <strong
                            style="color: red;">*</strong></label>
                    <input class="form-control readonly" readonly name="ma_kh" type="text" placeholder="Tên đăng nhập"
                        id="username" value="<?= $ma_kh ?>">
                </div>
                <div class="form-group">
