        ...
        function drawChart() {
            var data = google.visualization.arrayToDataTable([
                ...
                foreach ($productsOfType as $type) {
                    extract($type); ?>['<?= ucfirst($ten_loai); ?>', <?= $so_luong ?>, 'fill-color: rgb(0, 0, 0)'],
                <?php } ?>
            ]);
                    ...
                    <div class="statistics">
                        <a href="<?= $ADMIN_URL ?>/bill?btn_list" class="statistics-item">
                            ...
                            <div class="statistics-item-content">
                                ...
                                <span><?php foreach ($bills as $bill) {
                                            extract($bill);
                                            echo $so_luong;
                                        } ?></span>
                            </div>
                        ...
                        <a href="<?= $ADMIN_URL ?>/goods?btn_list" class="statistics-item">
                            ...
                            <div class="statistics-item-content">
                                ...
                                <span><?php foreach ($products as $product) {
                                            extract($product);
                                            echo $so_luong;
                                        } ?></span>
                            </div>
                        ...
                        <a href="<?= $ADMIN_URL ?>/customer?btn_list" class="statistics-item">
                            ...
                            <div class="statistics-item-content">
                                ...
                                <span><?php foreach ($customers as $customer) {
                                            extract($customer);
                                            echo $so_luong;
                                        } ?></span>
                            </div>
                        ...
                        <a href="<?= $ADMIN_URL ?>/comment" class="statistics-item">
                            ...
                            <div class="statistics-item-content">
                                ...
                                <span><?php foreach ($comments as $comment) {
                                            extract($comment);
                                            echo $so_luong;
                                        } ?></span>
                            </div>
